...
@click.pass_context
def cli_main(ctx: 'Context', config_file_path, debug):
    """`crcr`の起点.
...
# def cli_main_migrate(ctx: 'Context', dry_run, database_url):
#     """DBを最新スキーマの状態にあわせる.
...
#         db = Database(database_url, tmpdir, tmpdir)
